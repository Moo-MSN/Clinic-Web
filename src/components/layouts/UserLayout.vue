...
<template>
  <div > 
    ...
    <div class="navbar bg-purple-100 shadow-sm">
      ...
      <div class="navbar-end hidden lg:flex md:manu-bar  mx-10">
  ...
  <!-- Footer -->
  <div>
    <footer class="footer sm:footer-horizontal bg-purple-500 text-neutral-content p-10">
      <aside>
        ...
        <p>
          Clininc Name
          <br />
          Providing reliable tech since 1992 อาจจะลบออก
        </p>
      </aside>
      <nav>
